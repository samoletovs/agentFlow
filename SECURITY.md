...
Send a private report via [GitHub Security Advisories](https://github.com/samoletovs/agentFlow/security/advisories/new) or email the maintainer directly (see GitHub profile).
